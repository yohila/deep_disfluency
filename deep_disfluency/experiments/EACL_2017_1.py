...
file_divisions_transcripts = [
    ('train1', range_dir + '/swbd_disf_train_1_ranges.text'),
    ('train', range_dir + '/swbd_disf_train_1_2_ranges.text'),
...
if extract_features:
    ...
    for div, divfile in file_divisions_transcripts:
        c = [sys.executable, THIS_DIR + '/../feature_extraction/extract_features.py',
