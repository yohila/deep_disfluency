...
if __name__ == '__main__':
    ...
    write_mapping = True
    THIS_DIR = "/home/asani/Python_Porjects/deep_disfluency/deep_disfluency/"
    #"../../../swbd/MSaligned/alignments"
    #nb don't really need the below, just for writing map
    if write_mapping:
        print(args.corpusLocation)
        timings_corpus_file = open( args.corpusLocation.replace("data.csv", "data_timings.csv"),"w")
